...
(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        $(".testimonial__item__wrapper").not(".slick-initialized").slick({
            ...
            slidesToScroll: 1,
            arrows: true,
            prevArrow: "<button type='button button--effect' class='slick-prev pull-left button arrow--button'><i class=\"fa-solid fa-arrow-right-long\"></i></button>",
            nextArrow: "<button type='button button--effect' class='slick-next pull-right button arrow--button'><i class=\"fa-solid fa-arrow-left-long\"></i></button>",
            dots: false,
        });
